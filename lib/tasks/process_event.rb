...
keys.each do |key|
  ...
  datas.each do |data|
    ...
    Event.create(event_id: data.deal_item.item_id, event_name: data.deal_item.deal_title, event_url: data.deal_item.deal_url, event_site_id: word_data.id, show_flg: true)
  end
end
