  ...
  def create    
    ...
    respond_to do |format|
      if @event_detail.save
        if Rails.env == 'development'
          format.html { redirect_to :action => "show", id: @event_detail.id }
        else
...
#         
  ...
  private
    ...
    def event_detail_params
      params[:event_detail].permit(:event_id, :title, :first_text, :content_1, :content_2, :content_3, :content_4, :content_5, :content_6, :content_7, :content_8, :content_9, :content_10, 
